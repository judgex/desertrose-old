...
GLOBAL_LIST_INIT(available_ui_styles, list(
	"Fallout New" = 'icons/mob/screen_fallout.dmi',
	"Fallout Legacy" = 'icons/mob/screen_fallout_legacy.dmi',
	"Fallout Vegas" = 'icons/mob/screen_fallout_vegas.dmi',
	"Fallout Vault" = 'icons/mob/screen_fallout_vault.dmi'
))
