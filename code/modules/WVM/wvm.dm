...
/obj/machinery/mineral/wasteland_vendor/camp
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Keep your C.A.M.P. Clean: Trashbag",		/obj/item/storage/bag/trash,							400),
		new /datum/data/wasteland_equipment("Keep your C.A.M.P. Clean: Soap",			/obj/item/soap/homemade,								600)
		)
