...
/obj/structure/decoration_f13/panel
	name = "прибор"
	desc = " акой-то военный прибор.  Ќе работает."
	layer = 3
	icon_state = "panel_1"
...
/obj/structure/decoration_f13/stove
	name = "плита"
	desc = "ƒовоенна€ плита, ржава€, стара€ и нерабоча€."
	layer = 3
	icon_state = "gasstove"
...
/obj/structure/decoration_f13/radiator
	name = "радиатор"
	desc = "Ѕольшие ржавые трубы, когда-то служившие системой отоплени€..."
	icon = 'icons/obj/structures.dmi'
	icon_state = "radiator"
	layer = 3.2
	density = 0
...
/obj/structure/decoration_f13/bunker_vent
	name = "вентил€тор"
	desc = "Ѕольшой вентил€тор, когда-то служивший системой подачи воздуха куда-то..."
...
/obj/structure/decoration_f13/bunker_vent/rusted
	name = "вентил€тор"
	desc = "Ѕольшой и ржавый вентил€тор, когда-то служивший системой подачи воздуха куда-то..."
	icon_state = "v_vent_rusted"

/obj/structure/decoration_f13/tv
	name = "старый телевизор"
	desc = "—тарый телевизор, покрыт пылью а электроника уже никогда не заработает."
	icon_state = "tv"
	layer = 3
...
/obj/structure/decoration_f13/decal/blood
	name = "кровь"
	desc = " ровь... ћного мать еЄ крови. ÷елое художество."
...
/obj/structure/decoration_f13/decal/hole
	name = "дырка от пули"
	desc = "ѕоходе, кто-то вЄл тут ожесточенную перестрелку...  огда-то."
...
/obj/structure/decoration_f13/decal/redcross
	name = "красный крест"
	desc = "—ильно потрЄпанна€ табличка, некогда обозначавша€ организованный медпункт..."
	icon_state = "blood_pic_2"

/obj/structure/decoration_f13/decal/corpse
	name = "труп"
	desc = "Ќу и срань ,что здесь произошло? ≈го просто разорвали в клочь€, не к добру это..."
	icon_state = "corpse"
	layer = 2
...
/obj/structure/decoration_f13/poster/vault_sign
	name = "номерна€ табличка"
	desc = "Ќомерна€ табличка обозначающа€ номер убежища, наверное..."
	icon_state = "vlt_113"

/obj/structure/decoration_f13/poster/kalendar
	name = "календарь"
	desc = "ќбычный календарь из бумаги неизвестного состава, это единственное объ€снение почему он дожил до наших дней."
	icon_state = "kalendar"
