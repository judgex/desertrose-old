...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	...
	null, \
		...
		new/datum/stack_recipe("booth table end", /obj/structure/table/booth, 2, time = 10), \
		new/datum/stack_recipe("booth table middle", /obj/structure/table/booth/middle, 2, time = 10), \
	)), \
		new /datum/stack_recipe_list("racks", list( \
