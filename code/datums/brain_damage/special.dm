...
/datum/brain_trauma/special/bluespace_prophet
	...
	scan_desc = "quantum attunement"
	gain_text = "<span class='notice'>You feel the quantum realm pulsing around you...</span>"
	lose_text = "<span class='warning'>The faint pulsing of quantum realm fades into silence.</span>"
	var/next_portal = 0
