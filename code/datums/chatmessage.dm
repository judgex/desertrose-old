...
/datum/chatmessage/proc/generate_image(text, atom/target, mob/owner, list/extra_classes, lifespan)
	...
	if (extra_classes.Find("emote"))
		var/image/r_icon = image(icon = 'icons/UI_Icons/chat/chat_icons.dmi', icon_state = "emote")
		text =  "\icon[r_icon]&nbsp;" + text
	else if (extra_classes.Find("virtual-speaker"))
		var/image/r_icon = image(icon = 'icons/UI_Icons/chat/chat_icons.dmi', icon_state = "radio")
		text =  "\icon[r_icon]&nbsp;" + text
